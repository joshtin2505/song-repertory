...
function Features() {
  const { features } = español.featuresSection
  return (
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p className="text-neutral-500 sm:text-xl dark:text-neutral-400">
            At Song Repertory, we create tools to simplify the management of
            your musical repertoire, facilitating organization and collaboration
